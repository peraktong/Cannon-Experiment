...
class plot_4:
    ...
    def plot(self,flux,ivar,error,star_name,test_label):
        ...
        plt.step(wl, nor[p1, :], "k", label=n1, alpha=1, linewidth=1.5)
        ...
        plt.step(wl, nor[p2, :], "k", label=n2, alpha=1, linewidth=1.5)
        ...
        plt.step(wl, nor[p3, :], "k", label=n3, alpha=1, linewidth=1.5)
        ...
        plt.step(wl, nor[p4, :], "k", label=n4, alpha=1, linewidth=1.5)
    ...
    def plot_v2(self,flux,ivar,error,star_name):
        ...
        ax1.step(wl, nor[p1, :], "k",label =n1, alpha=1, linewidth=1.5)
        ...
        ax3.step(wl, nor[p1, :], "k", label =n2,alpha=1, linewidth=1.5)
        plt.errorbar(wl, nor[p1, :], ecolor='k', alpha=trans / 10, capthick=0.2, yerr=error[p1, :])
        ...
        ax5.step(wl, nor[p1, :], "k",label = n3, alpha=1, linewidth=1.5)
        plt.errorbar(wl, nor[p1, :], ecolor='k', alpha=trans / 10, capthick=0.2, yerr=error[p1, :])
        ...
        ax7.step(wl, nor[p1, :], "k", label =n4,alpha=1, linewidth=1.5)
        plt.errorbar(wl, nor[p1, :], ecolor='k', alpha=trans / 10, capthick=0.2, yerr=error[p1, :])
