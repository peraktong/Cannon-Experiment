...
###################################
    ...
    def plot_calibrated(self, flux, ivar, error, star_name,inf_flux,inf_label):
    ...
    def plot_half_para(self, flux, ivar, error, star_name,inf_flux,inf_label):
        ...
        inf_opt, parameters_4 = self.model.fitting_spectrum_para_a0b0c0(wl,
            all_set_flux, all_set_ivar, inf_old)
