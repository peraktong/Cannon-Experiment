...
In our experiment except calculating $\theta_{j}$, we calculate a, b and c independently for each star, which means N=1 in formula(4)(5)(6)(7).
...
\centerline{Fig.3 Histogram for  a, b and c}
...
\centerline{Fig.4 a,b,c vs Mean Fiber Number}
\bigskip
...
\centerline{Fig.5 Delta-chi-squared vs Mean Fiber Number}
\bigskip
