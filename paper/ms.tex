...
We will plot the histogram for the five parameters in our experiment.
...
In figure 17 and 18, we plot the continuum-normalized fluxes of all visits for the first star in figure 8. There are 6 individual visits and 2 combined spectrums. So in figure 17 and 18, there are 8 fluxes. The bottom two are the combined spectrum and the other 6 are individual visits. We can see that the absolute value of the flux for each visit is similar to each other, which means our normalization works.
...
\centerline{The bottom two are the combined spectrum and the other 6 are individual visits. The red dots are continuum pixels }
\bigskip

\begin{center}
\includegraphics[width=170mm]{figure_18.png}
\end{center}


\centerline{Fig.18 Comparison of each visit for the first star in figure 8.}
\centerline{The bottom two are the combined spectrum and the other 6 are individual visits. The red dots are continuum pixels }
\bigskip
...
\centerline{Diagnostic Fig.7 Radial velocity shifts}
\centerline{ $v_3$ is the RV shift obtained from a, b and c. $v_5$ is from the five parameters. $v$ is from a, b and c if $2b>a+c$ and $v$ = $v_5$ if $2b<a+c$}
\bigskip
