...
Comparison of the spectrum if we set the parameters showed in old figure 8. In old figure 8, the red line and the green line are on the top of each other
 \bigskip
...
\centerline{Diagnostic Fig.2 Comparison of the spectrum if we set the parameters showed in old figure 8}
\bigskip

 
 
 Comparison of the spectrum if we set the parameters showed in old figure 9. In old figure 9, the difference between red line and the green line is too big if we consider their parameters.
 \bigskip
...
\centerline{Diagnostic Fig.3 Comparison of the spectrum if we set the parameters showed in old figure 9}
\bigskip
