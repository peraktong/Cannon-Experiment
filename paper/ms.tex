...
Working on it...
I think one possible way is to use the velocities correction for the APOGEE data obtained from the spectrum calibration section. Then the optimized APOGEE spectrum can be represented as:
You should look into the velocities and find a right way to describe them.
...
\centerline{Fig.1 Histogram of a b c for apstar data (What we use now)}
\bigskip

 
 
Plot log g vs teff for all the stars we use in the training step.


\includegraphics[width=170mm]{d_figure_2.png}
\bigskip

\centerline{Fig.2 Log g vs Teff for the training set}
\bigskip


Randomly choose four stars and manually set their a, b and c equal to parameters in figure 8, then plot the spectrum. The difference between a and c is about 0.3.


\includegraphics[width=170mm]{d_figure_3.png}
\bigskip

\centerline{Fig.3 Comparison of the spectrum}

\centerline{ The black line is the observed spectrum. The green line is the inferred spectrum and the red line is the optimized }
\bigskip

Randomly choose four stars and manually set a = 0.7 b = 0.2 c = 0.1, then plot the spectrum. The difference between a and c is 0.6.
...
\centerline{Fig.4 Comparison of the spectrum}

\centerline{ The black line is the observed spectrum. The green line is the inferred spectrum and the red line is the optimized }
\bigskip

Randomly choose four stars and manually set a = 2 b = -2 c = 1, then plot the spectrum. The difference between a and c is 1.


\includegraphics[width=170mm]{d_figure_5.png}
\bigskip

\centerline{Fig.5 Comparison of the spectrum}

\centerline{ The black line is the observed spectrum. The green line is the inferred spectrum and the red line is the optimized }
\bigskip


Diagnostic. The parameters showed in figure 6 are the parameters obtained from the optimization process using labels from the APOGEE team, which is not correct. But the parameters to generate optimized flux are from the optimization process using labels from the Cannon, which should be correct.


\includegraphics[width=170mm]{d_figure_6.png}
\bigskip

\centerline{Fig.6 Comparison of the spectrum}

\centerline{ The black line is the observed spectrum. The green line is the inferred spectrum and the red line is the optimized }
\bigskip

Diagnostic. If using the old parameters, the plot should looks like figure 7. There will be a big different between the red line and the green line.


\includegraphics[width=170mm]{d_figure_7.png}
\bigskip

\centerline{Fig.7 Comparison of the spectrum}

\centerline{ The black line is the observed spectrum. The green line is the inferred spectrum and the red line is the optimized }
\bigskip

Diagnostic. This is what the old figure 10 looked like. There isn't a big different between the red line and the green line. This parameter set is wrong.


\includegraphics[width=170mm]{d_figure_8.png}
\bigskip

\centerline{Fig.8 Comparison of the spectrum}
