...
Thus we can use a, b and c to determine the radial velocity shift for the combined spectrum and each visit of the APOGEE data.
\begin{equation}
v_{shift} = {{(c-a)*v_{pixel}}\over{4\cdot(a+c-2b)}}
\end{equation}
Where $v_{shift}$ is the shift of the radial velocity in APOGEE data and $v_{pixel}$ =  4144.68 m/s.
\bigskip
