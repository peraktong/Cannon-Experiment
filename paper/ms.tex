...
Choose four stellar, which are not in the training set. Optimize the spectrum of these four stars and obtain a, b and c for each stars. The labels we use are from the Cannon, which means they are inferred labels.
