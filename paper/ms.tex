...
Because linear regression is sensitive to bad data points, extra parameters need to be added to describe the bad data points. Here we introduce \(\big\{q_n\big\}_{n=1}^{N}\), \(P\), \(Y\) and \(V\). 

We need to find a correct objective function! 
...
popt, pcov= optimization.curve\_fit(func, (x\_data, y\_data, z\_data),nor\_r, x0, sigma=error)
\bigskip
