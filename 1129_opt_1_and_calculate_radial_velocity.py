...
velocity_correction = []
n_star = len(parameters_500[:,0])

for i in range(0,n_star):
    velocity_correction.append((parameters_500[i, 2] - parameters_500[i, 0]) * 4144.68)
...
output = open('n_velocity_correction_900.pkl', 'wb')
pickle.dump(velocity_correction, output)
output.close()


output = open('n_inf_flux_900.pkl', 'wb')
pickle.dump(inf_flux_500, output)
output.close()


output = open('n_inf_label_900.pkl', 'wb')
pickle.dump(inf_label_500, output)
output.close()


output = open('n_opt_flux_900.pkl', 'wb')
pickle.dump(opt_flux_500, output)
output.close()

output = open('n_parameters_900.pkl', 'wb')
pickle.dump(parameters_500, output)
output.close()

output = open('n_parameters_uncertainty_900.pkl', 'wb')
pickle.dump(uncertainty, output)
output.close()

output = open('n_delta_chi_900.pkl', 'wb')
