...
opt_flux_500,parameters_500 = model.fitting_spectrum_parameters_single(nor_test_flux,nor_test_ivar,inf_flux_500)
...
output = open('parameters_uncertainty.pkl', 'wb')
pickle.dump(uncertainty, output)
output.close()

output = open('delta_chi_500.pkl', 'wb')
