...
def fitting_ve(name):
    ...
    try:
        ...
        inf_flux = gpu_dot(v, model.theta.T)
        opt_flux, parameters = model.fitting_spectrum_parameters_single_gpu(norm_tr_flux, norm_tr_ivar, inf_flux)
