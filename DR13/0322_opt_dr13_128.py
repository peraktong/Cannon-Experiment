...
def fitting_ve(name):
    ...
    try:
        ...
        path_fits_i = image_path.replace("/Volumes/Data_2TB/Data/APOGEE_DR13_Apstar/apStar-r6-",
                                         "/Users/caojunzhi/Desktop/Data/dr13_128/")
...
pkl_file = open('dr13_path.pkl', 'rb')
dr13_path = pickle.load(pkl_file)
pkl_file.close()

length = len(dr13_path)
print(length)
print(dr13_path)
...
for i in range(0,stars):
    a += np.random.randint(1,length//stars-1)
    choose.append(a)

choose = np.array(choose)

dr13_part = dr13_path[choose]



mypath = "/Users/caojunzhi/Desktop/Data/dr13_128"
...
path_fits_dr13 = []
path_ori_dr13 = []
save_path = "/Users/caojunzhi/Desktop/Data/dr13_128/"

for i in range(0,len(dr13_part)):

    original_i = dr13_part[i]
    fits_i = original_i.replace("/Volumes/Data_2TB/Data/APOGEE_DR13_Apstar/apStar-r6-","/Users/caojunzhi/Desktop/Data/dr13_128/")
    ...
    if em==1:
        path_fits_dr13.append(fits_i)
        path_ori_dr13.append(original_i)
    else:
        print("%d failed"%i)



path_fits_dr13 = np.array(path_fits_dr13)
path_ori_dr13 = np.array(path_ori_dr13)


output = open('path_fits_dr13_128.pkl', 'wb')
pickle.dump(path_fits_dr13, output)
output.close()

output = open('path_ori_dr13_128.pkl', 'wb')
pickle.dump(path_ori_dr13, output)
output.close()
