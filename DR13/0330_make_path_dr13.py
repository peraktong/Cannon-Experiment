...
mypath = "/Volumes/data_2TB/Data/dr13_all/"
mypath_ori = "/Volumes/data_2TB/Data/APOGEE_DR13_Apstar/apStar-r6-"
...
output = open('dr13_fits.pkl', 'wb')
pickle.dump(rc_path, output)
output.close()

output = open('dr13_ori.pkl', 'wb')
