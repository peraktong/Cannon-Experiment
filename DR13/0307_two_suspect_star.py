...
##########
    ...
    ve_new = (parameters_new[:,2]-parameters_new[:,0])/(parameters_new[:,0]+parameters_new[:,1]+parameters_new[:,2])*4144.68
...
#############
    ...
    for j in range(0,n_i):
        ...
        #initial_j = inf_labels[j,:]
        #initial_j = np.append(initial_j,[0,1,0])
        #initial_j = np.atleast_2d(initial_j)
