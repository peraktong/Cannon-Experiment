...
class make_table():
    ...
    def read_data(self):
        ...
        pkl_file = open('/Users/caojunzhi/Desktop/NYU/Laboratory/task 2016.8.1-12.23/My codes/AnniesLasso_v2/dr13_rc_fits_atleast_4_epoch.pkl', 'rb')
        path_fits = pickle.load(pkl_file)
        pkl_file.close()


        pkl_file = open('/Users/caojunzhi/Desktop/NYU/Laboratory/task 2016.8.1-12.23/My codes/AnniesLasso_v2/dr13_rc_ori_atleast_4_epoch.pkl', 'rb')
